...
void DataThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DataThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataThread::testSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DataThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DataThread.data,
      qt_meta_data_DataThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
